...
The [source-data reference](../generated/isp2024/reference/source-data.md) identifies the source files and selections, the [parameters and mappings reference](../generated/isp2024/reference/parameters-and-mappings.md) defines package conventions, and the [output-tables reference](../generated/isp2024/reference/output-tables.md) defines the resulting tables.
...
build request
    |
    +-- download configured sources, or reuse existing files
    |
    v
extract archives
    |
...
The source files and selections are documented in [ISP 2024 source data](../generated/isp2024/reference/source-data.md).
...
The [composite-mapping analysis](../generated/isp2024/analyses/reference-trace-4006-composite-mapping.md) explains its planning-horizon composition, and [workbook and trace structure](../generated/isp2024/validation/workbook-and-trace-structure.md) describes the trace families and fields.
...
| --- | --- | --- |
| `download_from_AEMO` | Source acquisition | Downloads configured sources when enabled; extraction and preprocessing continue in either mode. |
